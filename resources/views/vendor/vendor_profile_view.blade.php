                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('vendor.profile.store') }}"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Vendor Business Name</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea type="text" name="address" class="form-control" value="{{ $vendorData->address }}">{{ $vendorData->address }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input name="vendor_joined" type="datetime-local" id="DatetimeLocal" value="{{ $vendorData->vendor_joined }}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control" id="vendorBio" placeholder="Vendor Bio..." row="3">{{ $vendorData->vendor_short_info }}"
                                            </textarea>
                                        </div>
                                    </div>
